...
export default function Footer() {
  return (
    <footer
      data-testid="footer"
      className="relative w-full bg-black border-t border-white/10 py-12 md:py-16"
    >
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        <div className="overflow-hidden mb-12 md:mb-16">
          <div className="text-[clamp(4rem,15vw,12rem)] tracking-tighter font-medium leading-none text-white/10 whitespace-nowrap select-none">
            M.STUDIO · PRECISION · DETAILING · M.STUDIO
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[13px] tracking-[0.32em] uppercase font-medium">M.STUDIO</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#process" className="text-white/80 hover:text-white">Процесс</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#BDBDBD]">
              ...
              <li><a href="mailto:hello@m.studio" className="hover:text-white">hello@m.studio</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-8 border-t border-white/10 text-[10px] tracking-[0.32em] uppercase text-white/40">
          <span>© 2026 M.STUDIO — Все права защищены</span>
