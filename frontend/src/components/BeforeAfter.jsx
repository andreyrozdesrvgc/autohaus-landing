      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10 md:mb-14">
          <div>
            ...
            >
              {ba.title_line_1}<br />{ba.title_line_2}
            </motion.h2>
          </div>
        ...
        >
          <img
            src={resolveMedia(ba.after_image)}
          ...
          >
            <img
              src={resolveMedia(ba.before_image)}
        ...
        >
          <p className="md:hidden text-[#BDBDBD] text-sm font-light leading-relaxed">
            {ba.cta_text_mobile_prefix}
            <span className="text-white">{ba.cta_text_mobile_strong}</span>
            {ba.cta_text_mobile_suffix}
          </p>
          <a
            href="#configurator"
