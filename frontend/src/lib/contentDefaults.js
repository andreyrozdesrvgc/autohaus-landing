...
export const FALLBACK_CONTENT = {
  ...
  live: {
    ...
    items: [
      { title: "BMW M4 · PPF Stealth", meta: "Полная оклейка · 5 дней", image: MEDIA.live.reel1.poster, cta_label: "Хочу так же" },
      { title: "BMW M5 · Vinyl Matte", meta: "Смена цвета · 4 дня", image: MEDIA.live.reel2.poster, cta_label: "Запросить смету" },
      { title: "BMW X5 M · Antichrome", meta: "Антихром · 2 дня", image: MEDIA.live.reel3.poster, cta_label: "Узнать стоимость" },
      { title: "BMW G80 · Headlights", meta: "Бронирование оптики · 1 день", image: MEDIA.live.reel4.poster, cta_label: "Заказать защиту" },
      { title: "BMW M3 · Satin Wrap", meta: "Сатиновая плёнка · 5 дней", image: MEDIA.live.reel5.poster, cta_label: "Подобрать цвет" },
    ],
  },
  team: {
    overline: "012 — Team",
    ...
    members: [
      { name: "Максим", role: "Владелец студии", focus: "PPF, антихром, сложные проекты", years: "8 лет", photo: "https://images.unsplash.com/photo-1607853554439-0069ec0f29b6?auto=format&fit=crop&w=1000&q=85" },
      { name: "Александр", role: "Мастер-оклейщик", focus: "Виниловая смена цвета", years: "6 лет", photo: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=1000&q=85" },
      { name: "Дмитрий", role: "Специалист PPF", focus: "Полиуретан, кузовные элементы", years: "5 лет", photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=1000&q=85" },
      { name: "Артём", role: "Мастер полировки", focus: "Подготовка ЛКП, коррекция", years: "7 лет", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1000&q=85" },
      { name: "Иван", role: "Оптика и бронирование", focus: "Фары, стёкла, кромки", years: "4 года", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1000&q=85" },
      { name: "Кирилл", role: "QC — контроль качества", focus: "Финальная приёмка, отчёт клиенту", years: "3 года", photo: "https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=1000&q=85" },
    ],
  },
  clients: {
