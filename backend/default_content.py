...
DEFAULT_CONTENT = {
    ...
    "studio_availability": {
        "visible": True,
        "overline": "002 — Live status",
        "title_line_1": "Загруженность",
        "title_line_2_grey": "студии",
        "title_line_2_white": " сегодня.",
        "description": "Работаем без спешки — каждому автомобилю уделяем внимание, которого он заслуживает. Проверьте свободные окна на завтра и забронируйте.",
        "free_slots_max": 2,
        "cars_in_work_min": 3,
        "cars_in_work_max": 6,
        "free_slots_label": "свободное окно",
        "free_slots_label_plural": "свободных окна",
        "free_slots_when": "на завтра",
        "cars_in_work_label_one": "автомобиль в работе",
        "cars_in_work_label_few": "автомобиля в работе",
        "cars_in_work_label_many": "автомобилей в работе",
        "posts_total_label": "из 6 боксов заняты",
        "cta_label": "Забронировать дату",
        "cta_note": "Оставьте заявку — мастер подберёт удобное окно и перезвонит за 15 минут.",
        "bonus_enabled": True,
        "bonus_minutes": 30,
        "bonus_overline": "Специальное предложение",
        "bonus_title": "Керамика фар в подарок",
        "bonus_sub": "При заказе полной оклейки PPF на кузов до конца дня.",
        "bonus_expire_label": "Предложение сгорает через",
    },
    "before_after": {
        "visible": False,
        "overline": "002 — Result",
    ...
    "live": {
        ...
        "items": [
            ...
            },
            {
                ...
                "image": "https://images.unsplash.com/photo-1617814086367-b8cb20edbe98?auto=format&fit=crop&w=900&q=85",
    ...
    "team": {
        "overline": "012 — Team",
        "title_line_1": "Наша",
        "title_line_2_grey": "команда.",
        "title_line_2_white": " precision-мастеров.",
        "description": "Каждый мастер — специалист в своей зоне. Совокупный опыт студии — более 30 лет precision-детейлинга.",
        "cta_prefix": "Записаться к",
        "footer_left": "Team · Kaliningrad · Since 2019",
        "footer_right": "Знаете, к кому хотите — напишите имя в форме, мы позовём именно этого мастера.",
        "members": [
            {
                "name": "Максим",
                "role": "Владелец студии",
                "focus": "PPF, антихром, сложные проекты",
                "years": "8 лет",
                "photo": "https://images.unsplash.com/photo-1607853554439-0069ec0f29b6?auto=format&fit=crop&w=1000&q=85",
            },
            {
                "name": "Александр",
                "role": "Мастер-оклейщик",
                "focus": "Виниловая смена цвета",
                "years": "6 лет",
                "photo": "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=1000&q=85",
            },
            {
                "name": "Дмитрий",
                "role": "Специалист PPF",
                "focus": "Полиуретан, кузовные элементы",
                "years": "5 лет",
                "photo": "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=1000&q=85",
            },
            {
                "name": "Артём",
                "role": "Мастер полировки",
                "focus": "Подготовка ЛКП, коррекция",
                "years": "7 лет",
                "photo": "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1000&q=85",
            },
            {
                "name": "Иван",
                "role": "Оптика и бронирование",
                "focus": "Фары, стёкла, кромки",
                "years": "4 года",
                "photo": "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1000&q=85",
            },
            {
                "name": "Кирилл",
                "role": "QC — контроль качества",
                "focus": "Финальная приёмка, отчёт клиенту",
                "years": "3 года",
                "photo": "https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=1000&q=85",
            },
        ],
    },
    "thank_you": {
        "overline": "AUTOHAUS · Kaliningrad",
        "title_line_1": "Спасибо.",
        "title_line_2_grey": "Скоро свяжемся.",
        "description": "Мы уже видим вашу заявку и вернёмся с расчётом в течение 15 минут в рабочее время. Обычно быстрее.",
        "messenger_prompt": "Хотите быстрее? Напишите нам напрямую",
        "telegram_url": "https://t.me/detailing_autohaus",
        "whatsapp_url": "https://wa.me/79000000000",
        "max_url": "https://max.ru/detailing_autohaus",
        "maps_url": "https://yandex.ru/maps/-/CDgHRW-e",
        "maps_label": "Открыть на карте",
        "back_home_label": "На главную",
    },
    "clients": {
        "overline": "013 — Trusted by",
        "title_line_1": "Наши",
        "title_line_2_grey": "клиенты.",
        "description": "Руководители известных компаний Калининграда доверяют свои автомобили нашей студии.",
        "footer_note": "Логотипы приведены с согласия клиентов.",
        "items": [
            {"logo": "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/mercedes.svg", "name": "Mercedes Group"},
            {"logo": "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/bmw.svg", "name": "BMW Baltic"},
            {"logo": "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/porsche.svg", "name": "Porsche Kaliningrad"},
            {"logo": "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@develop/icons/audi.svg", "name": "Audi Club KGD"},
        ],
    },
    "quiz": {
