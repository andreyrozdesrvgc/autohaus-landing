...
DEFAULT_CONTENT = {
    ...
    "quiz": {
        ...
        "expert_name": "Артём Соколов",
        "expert_role": "Основатель AUTOHAUS · 15 лет в детейлинге",
        ...
        "thanks_subtitle": "Артём перезвонит в течение 15 минут с готовым расчётом.",
